						...
						<table class="table table-responsive table-sm">
							<td>
								<div class="answer">
									...
									<label for="q3-a">1.Memiliki arti sama</label>
								</div>
							</td>
							<td>
								<div class="answer">
									<input name="q3" value="a" id="q3-b" type="radio" />
									<label for="q3-b">2.Memiliki arti berlawanan</label>
								</div>
							</td>
							<td>
								<div class="answer">
									<input name="q3" value="a" id="q3-c" type="radio" />
									<label for="q3-c">3.Tidak memiliki arti sama atau berlawanan</label>
								</div>
							</td>
						</table>
						</form>
